...
\* It is possible to skip VEP annotation and reduce disk space requirements. Set the `USE_VEP=1` variable to `0` in the `.env` file before you run the project. Fasta files and chain files **must** be downloaded to use make variant queries.
